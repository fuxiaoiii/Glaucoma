...
def main(path_to_config= 'configs/sample.yaml',folds=5):
    ...
    assert os.path.exists(output_dir), 'Fold already exists!'
    ...
    for k in range(folds):
        ...
        if scheduler == 'step':
            ...
            optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=5)
        ...
        with open(os.path.join(output_dir, f"log_{exp_id}_{fold_num}.csv"), "a") as f:
            ...
            checkpoint = torch.load('Checkpoints/airogs_2.pt')
            ...
            if epoch_resume < epochs:
                ...
                for epoch in range(epoch_resume, epochs):
                    ...
                    for split in ['Train', 'Val']:
                        ...
                        acc_ill = confusion[1][1] / (confusion[1][0] + confusion[1][1])
                        ...
                        if split == 'Train':
                            ...
                            wandb.log({"epoch": epoch, "val loss": avrg_loss, "val acc": accuracy, "val f1": _f1_score, "val auc": auc,"acc_ill":acc_ill})
